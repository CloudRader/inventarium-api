...
## [0.0.2](https://github.com/CloudRader/inventarium-api/compare/v0.0.1...v0.0.2) (2026-03-29)
...
* add AuditLog Entity ([1f5a99b](https://github.com/CloudRader/inventarium-api/commit/1f5a99b0f786956365fa35896bfebb3fd31da776))
* add AuditLog repository and service ([d230163](https://github.com/CloudRader/inventarium-api/commit/d230163e555e37447bdd5f6d1891b806ee89b6e9))
* add blueprint init config for authentik in start up ([641afb1](https://github.com/CloudRader/inventarium-api/commit/641afb161466e77d568f9ce1309de46c9d1e6f56))
...
* add crud operations to tenant ([5185046](https://github.com/CloudRader/inventarium-api/commit/5185046cb5c2cc7b17ea8b2fbcc047d3cf1b6244))
...
* add init primary tenant and IdP at start app if not exist ([d2b3181](https://github.com/CloudRader/inventarium-api/commit/d2b318134150fb4e83b5535d55586531588ce58e))
...
* add pre-commit config ([9f688c8](https://github.com/CloudRader/inventarium-api/commit/9f688c893319cb9de754d9a11a514356c9ffe88c))
* add primaryProvider as true in DataInitializer ([d13300c](https://github.com/CloudRader/inventarium-api/commit/d13300cedd4b2567968de4082a2d67013800ab92))
...
* add tenantId and createdAt column in User ([5be0053](https://github.com/CloudRader/inventarium-api/commit/5be0053f0a436fb74516c0967a5046a37b1c9b24))
* add to blueprint scope and signing key setup in authentik ([923709e](https://github.com/CloudRader/inventarium-api/commit/923709ecbead9eb52d398caab3bd4e7333a2db3d))
...
* change PlatformAdminService to reactive ([9651cd3](https://github.com/CloudRader/inventarium-api/commit/9651cd335f3b1d6e6d03b8440fc3f907ca6967b7))
...
* migrate ReactiveCrudRepository to CoroutineCrudRepository ([6cb9f4d](https://github.com/CloudRader/inventarium-api/commit/6cb9f4d6bdf28063a1b44f49f5c7256bb327c6b9))
...
* start migrate from sync to async ([4459910](https://github.com/CloudRader/inventarium-api/commit/4459910309a8ead6d133d2b74bfc2daa9d5be1ee))
* update and fix IdP from blocking to react style ([a361655](https://github.com/CloudRader/inventarium-api/commit/a361655f2bbe6907c28f1599df1d2718b3c5e877))
...
* update User (var -&gt; val) and Tenant Entity, fix migrations ([08f01d6](https://github.com/CloudRader/inventarium-api/commit/08f01d62ef01817c1d6ac3319671ca907615cda1))
* update User model for reactive style ([366e67b](https://github.com/CloudRader/inventarium-api/commit/366e67b2dd1a820a2c7abd1924f921c62520aab4))


### 🛠️ Fixes

* blueprint volume and admin bootstrap cred for authentik ([7dcd32c](https://github.com/CloudRader/inventarium-api/commit/7dcd32cbdeb5c565610f7219ab59dd577761dc68))
* detekt warnings ([b6d2dcf](https://github.com/CloudRader/inventarium-api/commit/b6d2dcf461147e32ee328abc43f22ab5a46821b6))
* insert user with external id and login with alias from tenant not IdP ([6054148](https://github.com/CloudRader/inventarium-api/commit/6054148faeb56d00a54ce1480dcdd8213f04f522))
* save tenant to db, use data class for entity ([ce82dc4](https://github.com/CloudRader/inventarium-api/commit/ce82dc456435d93d55ba8de2207186853cd3a113))
* start run app, commented basic security ([4de739e](https://github.com/CloudRader/inventarium-api/commit/4de739ef19c7bd16162cade67151989b38f17364))


### 🧹 Refactors

* **async:** migrate blocking to async ([88a91f2](https://github.com/CloudRader/inventarium-api/commit/88a91f2950891dd27e7612b16255fa72d120d9c0))
...
* infrastructure in scr code (domain and infrastructure models) ([78ec0cf](https://github.com/CloudRader/inventarium-api/commit/78ec0cfa9b3c7a0a96896fb4a0bd6c9b05ea32d2))
* merge two migrations to one ([491761c](https://github.com/CloudRader/inventarium-api/commit/491761cc52689a788b4581c1bcc204c370a24d2c))
...
* remove everywhere basic auth with platform admin, fix deps ([bf7175b](https://github.com/CloudRader/inventarium-api/commit/bf7175b9b3aee205210696d98890248abe09f7bf))
...
* return "?: run {}" kotlin style ([89c7601](https://github.com/CloudRader/inventarium-api/commit/89c7601bd0c21989d7b13a1f532730152dbca407))
* use init script for create database for authentik ([eef8bc5](https://github.com/CloudRader/inventarium-api/commit/eef8bc583d9b4184b6f9b20b74edf00dc9c47de4))
