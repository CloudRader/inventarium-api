...
class TenantController(
    ...
    suspend fun create(
        @RequestBody tenantCreate: TenantCreateDto
    ): TenantDto {
    ...
    suspend fun getByAlias(
        ...
        return tenantService.getByAlias(alias)
    }
    ...
    suspend fun update(
        @PathVariable id: UUID,
        @RequestBody updateDto: TenantUpdateDto,
    ): TenantDto {
        return tenantService.update(id, updateDto)
    }
